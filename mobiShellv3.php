<?php
error_reporting(0);
$pass=14789; //// SET YOUR PATTERN HERE //// DEFAULT IS 'L' SHAPED
...
if (isset($_POST['pass']))
{
	if (htmlspecialchars($_POST['pass'])==$pass)
		echo 1;
	else
		echo 2;
	die();
...
<head>
	...
	<title>Mobile Shell V 0.3 | The Alien	</title>
	<meta http-equiv="imagetoolbar" content="no">
	<link rel="SHORTCUT ICON" href="https://ijazurrahim.com/mobiShell/icons/icon.png">
	<meta property="og:title" content="Mobile Shell V 0.3 | The Alien" />
    ...
    <link href="https://ijazurrahim.com/mobiShell/patternLock/patternLock.css" rel="stylesheet">
	<script src="https://www.w3schools.com/lib/codemirror.js"></script>
	<script src="https://ijazurrahim.com/mobiShell/patternLock/patternLock.min.js"></script>
...
<body onload="startTime()"> 
		...
		<div class="lockArea">
			<div class="patternTime"></div>
			<div class="pattern-msg">Draw Your Pattern</div>
 		...
 		var lock = new PatternLock("#patternContainer",{
						    onDraw:function(pattern)
						    {
						        ...
						        $.post(fName(),
						         ...
						         function(data) {
						        	if (data==1) {
						        		$(".pattern-msg").html("<font color=green>Pattern Correct</font>");
						        		$(".lockArea").fadeOut(2000,function()
						        		{
						        			$(".apps").fadeIn(1000);
						        		});
						        	}
						        	if (data==2) {
						        		lock.error();
						        		$(".pattern-msg").html("<font color=red>Pattern Invalid</font>");
						        		setTimeout(function(){
						        			lock.reset();
						        			$(".pattern-msg").html("Draw Your Pattern");
						        		},1000);
						        	}
						        });
						    }
